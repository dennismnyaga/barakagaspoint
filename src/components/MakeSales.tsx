...
const SalesTableRow = ({ gas, handleUpdate }) => {
  ...
  return (
    <TableRow key={gas.id}>
      ...
      <TableCell align="right">{gas.cylinder.weight.weight}(Kg)</TableCell>
      <TableCell align="right">{gas.assigned_quantity}</TableCell>
        ...
        <div>
          ...
          <div className=" text-black">
            <div className=" h-36 bg-blue-400 flex flex-col">
              <div className=" px-2 ">
                <h5 className=" text-center font-extrabold text-white underline">
                  Employees
                </h5>
            ...
            <Table sx={{ minWidth: 650 }} stickyHeader aria-label="sales table">
              <TableHead>
                <TableRow>
                  ...
                  <TableCell align="right">Update Quantity</TableCell>
                </TableRow>
              </TableHead>
